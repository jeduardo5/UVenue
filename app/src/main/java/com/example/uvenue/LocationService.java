/**
 * This is a background service that will check the users current location based on network provider with an interval of 1 second for now.
 */
...
public class LocationService extends Service {
    ...
    private void sendLocationMessage(Location location, LatLng ll){
        ...
        intent.putExtra("LatLng", ll.getLatitudeStr()+","+ll.getLongitudeStr());
